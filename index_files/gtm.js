...
"resource": {
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",84],
      "arg1":"public\\.(.*)\\.tabint.net|public-stage\\.tableau\\.com",
      "ignore_case":true
    },{
      "function":"_re",
      "arg0":["macro",0],
  ...
  "rules":[
    [["if",0,1],["add",0,1,4]],
    [["if",0,1,4],["add",2,3,5]],
    [["if",2,6,7],["add",6],["block",8,10,22,23]],
    [["if",7,8],["add",7,8,9]],
    [["if",9,10],["add",10,16]],
    [["if",11],["add",11]],
    [["if",7],["add",12,22,25,26,27,28,29,30,31]],
    [["if",13,14],["add",13]],
    [["if",7,12],["add",14],["block",12,15,16,17,32,34,35,36]],
    [["if",2,7],["add",15,24]],
    ...
    [["if",7,29],["add",32]],
    [["if",30,31],["add",33]],
    [["if",7],["unless",32],["add",34,35,36]],
    [["if",23,34],["add",37]],
    [["if",2,3],["block",0,2]],
    [["if",3,4],["block",0,1,4]],
    [["if",3],["unless",5],["block",0,1,2,3,4,5,6,11,12,14,16,17,18,19,20,21,32,33]],
    [["if",6,7],["block",7,16]],
    [["if",4,7],["block",7]],
    [["if",7,15],["block",15,32]],
    [["if",3],["unless",16],["block",15,34,35,36]],
    [["if",9,17,18],["block",16]],
    [["if",7,33],["block",34,35,36]]]
},
"runtime":[]
...
function Up(a,b){}var Z={a:{}};Z.a.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.b="ctv";Z.__ctv.g=!0;Z.__ctv.priorityOverride=0})(function(){return"49"})}();
...
e("_setSiteSpeedSampleRate","vtp_siteSpeedSampleRate");l("page","vtp_page");e("_setDomainName","vtp_domainName");e("_setAllowLinker","vtp_allowLinker");
...
v)}l("anonymizeIp","vtp_anonymizeIp");c.vtp_enableInPageLinkId&&d("_require","inpage_linkid","//www.google-analytics.com/plugins/ga/inpage_linkid.js");e("_setCampMediumKey","vtp_campMediumKey");e("_setCampNameKey",
"vtp_campNameKey");e("_setCampSourceKey","vtp_campSourceKey");e("_setCampTermKey","vtp_campTermKey");
e("_setCampaignTrack","vtp_campaignTrack");e("_setClientInfo","vtp_clientInfo");e("_setDetectFlash","vtp_detectFlash");
e("_setDetectTitle","vtp_detectTitle");void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(t.push(["_gat._forceSSL"]),p=!!c.vtp_forceSsl);
d("_set","hitCallback",function(){Aa(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TIMING"==c.vtp_trackType){}else if("DECORATE_LINK"==c.vtp_trackType){}else if("DECORATE_FORM"==c.vtp_trackType){}else d("_trackPageview");
...
Z.a.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:xm()}function b(f,h){nd(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:zm(l),R:ym(l)})})}function c(f,h){nd(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:zm(l),R:ym(l)})})}function d(f,h,k){var l=h.history,r=l[f];if(Aa(r))try{l[f]=function(q,n,t){r.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:zm(xm()),
R:ym(xm())})}}catch(q){}}function e(){var f={source:null,state:V("history").state||null,url:zm(xm()),R:ym(xm())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.R!=h.R){var r={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.R,"gtm.newUrlFragment":h.R,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;Bm(r)}}}(function(f){Z.__hl=f;Z.__hl.b="hl";Z.__hl.g=!0;Z.__hl.priorityOverride=
0})(function(f){var h=V("self");if(!Gm("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);Hm("hl")}I(f.vtp_gtmOnSuccess)})}();
...
Z.a.hid=["google"],function(){(function(a){Z.__hid=a;Z.__hid.b="hid";Z.__hid.g=!0;Z.__hid.priorityOverride=0})(function(){return Ul.bc})}();
