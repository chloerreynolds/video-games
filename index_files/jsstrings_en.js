...
// DEPENDS ON: ['workgroup/vqlweb/scriptsharp/src/Resources/Strings/Strings.en.resx', 'workgroup/vqlweb/scriptsharp/src/Resources/Strings/resx-strings-js.template']
...
(function(w) {
  var s = {
    ...
    AddFloatingTextZoneInStoriesLabel: "Double click to add text",
    ...
    AuthoringAutoRecoveredSessionMessageSaveNoSaveAs: "Initial workbook edits for the session were recovered. To save all edits, click File, and then click Save. To open the saved workbook, click File, and then click Revert.",
    ...
    ConnectionDialogSubtitleCreateAndConnect: "Create a new data source from scratch or choose an existing data source to start from.",
    ...
    DataMonitoringToolbarButtonLabel: "Data Monitoring",
    ...
    DiscoverToolbarButtonLabel: "Discover",
    ...
    EditWorkbookInTableauDesktopTooltip: "Edit Workbook in Desktop",
    ...
    ExportFileConfirmationDialogMessage: "The file has been downloaded.",
    ...
    ExportPowerPointDialogMessage: "The PowerPoint has been generated.",
    ...
    ExtensionDeniedByUserAuthoring: "This extension does not have permission to run. To grant approval, choose Reset Permissions in the extension context menu.",
    ...
    PrintPdfDialogMessage: "The PDF has been generated.",
    ...
    SessionExpiryWarning: "Session timed out due to inactivity. Your workbook has been restored to its original state.",
